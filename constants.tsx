...
export const MODULES: ModuleData[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 8, peso: 9, pregunta: "¿La organización ha definido, aprobado formalmente y mantiene estándares de configuración segura (secure baselines) para estaciones de trabajo, servidores y dispositivos de red, y verifica de forma periódica que los activos productivos se encuentren alineados a dichos estándares?" },
      ...
      { id: 21, peso: 9, pregunta: "¿La organización mantiene un proceso formal y documentado de gestión de vulnerabilidades que cubra todos los activos en alcance, defina roles, fuentes de información, criterios de priorización por riesgo y se ejecute de manera periódica con evidencia verificable?" },
      ...
      { id: 25, peso: 7, pregunta: "¿La organización cuenta con un proceso formal y documentado de gestión de registros de auditoría, que defina qué eventos se registran, dónde se almacenan, por cuánto tiempo, responsabilidades y controles de integridad, y que se revise periódicamente?" },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 3, peso: 8, pregunta: "¿La organización trata únicamente los datos personales estrictamente necesarios para cada finalidad y cuenta con reglas formales de conservación, supresión o anonimización, aplicadas efectivamente una vez cumplido el propósito del tratamiento o vencidos los plazos legales?" },
      ...
      { id: 21, peso: 9, pregunta: "¿La organización aplica medidas técnicas y organizativas de protección de datos desde el diseño, antes y durante el tratamiento, considerando estado de la técnica, costos de implementación, naturaleza, contexto, fines y riesgos, y puede acreditar su aplicación en proyectos, sistemas o procesos nuevos o modificados?" },
      ...
      { id: 28, peso: 10, pregunta: "¿Existe un procedimiento formal y operativo para notificar sin dilaciones indebidas a la Agencia las vulneraciones de seguridad de datos personales cuando exista riesgo razonable para los derechos y libertades de los titulares, y puede acreditarse su aplicación efectiva?" },
