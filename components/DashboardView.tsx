...
import { calculateModuleScore, getRiskLevel, getScoreLevel1000 } from '../utils/scoring';
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-1000 pb-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        {/* Gauge Card */}
        <div className="lg:col-span-5 bg-white rounded-[3rem] p-10 shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-slate-100 flex flex-col items-center justify-center min-h-[450px] relative overflow-hidden group">
        ...
        {/* Radar Card */}
        <div className="lg:col-span-7 bg-white rounded-[3rem] p-10 shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-slate-100 min-h-[450px]">
          <div className="flex items-center justify-between mb-8">
            <h4 className="text-[11px] font-black text-slate-400 uppercase tracking-[0.4em]">Arquitectura de Riesgo</h4>
